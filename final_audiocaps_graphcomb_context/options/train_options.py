...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument(
            "--display_freq", type=int, default=10, help="frequency of displaying average loss and accuracy"
        )
        self.parser.add_argument(
            "--save_latest_freq", type=int, default=200, help="frequency of saving the latest results"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--tensorboard", type=bool, default=False, help="use tensorboard to visualize loss change "
        )
        self.parser.add_argument(
            "--measure_time", type=bool, default=False, help="measure time of different steps during training"
        )
        self.parser.add_argument(
            "--niter",
            type=int,
            default=1,
            help="# of epochs to train, set to 1 because we are doing random sampling from the whole dataset",
        )
        ...
        self.parser.add_argument(
            "--num_object_per_video", default=2, type=int, help="max number of objects detected in a video clip"
        )
        self.parser.add_argument(
            "--validation_on", type=bool, default=True, help="whether to test on validation set during training"
        )
        self.parser.add_argument(
            "--validation_freq", type=int, default=500, help="frequency of testing on validation set"
        )
        self.parser.add_argument(
            "--validation_batches", type=int, default=10, help="number of batches to test for validation"
        )
        self.parser.add_argument(
            "--validation_visualization", type=bool, default=False, help="whether save validation predictions"
        )
        self.parser.add_argument(
            "--num_visualization_examples", type=int, default=20, help="number of examples to visualize"
        )
        self.parser.add_argument(
            "--subtract_mean", default=False, type=bool, help="subtract channelwise mean from input image"
        )
        self.parser.add_argument(
            "--preserve_ratio",
            default=False,
        ...
        self.parser.add_argument(
            "--enable_data_augmentation", type=bool, default=True, help="whether to augment input audio/image"
        )
        ...
        self.parser.add_argument(
            ...
            type=str,
            default="maxpool",
            help="avg/max pool or using a conv1x1 layer for visual stream feature",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--coseparation_loss_weight", default=1, type=float, help="weight for reconstruction loss"
        )
        self.parser.add_argument(
            "--mask_loss_type",
            default="L1",
            type=str,
            choices=("L1", "L2", "BCE"),
            help="type of reconstruction loss on mask",
        )
        ...
        self.parser.add_argument(
            "--with_additional_scene_image", action="store_true", help="whether to append an extra scene image"
        )
        ...
        self.parser.add_argument(
            "--lr_classifier", type=float, default=0.001, help="learning rate for audio classifier"
        )
        self.parser.add_argument("--lr_graph_net", type=float, default=0.0001, help="learning rate for graph encoder")
        self.parser.add_argument(
            "--lr_steps", nargs="+", type=int, default=[10000, 20000], help="steps to drop LR in training samples"
        )
